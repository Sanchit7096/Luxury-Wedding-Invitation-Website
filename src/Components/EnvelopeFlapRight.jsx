...
const EnvelopeFlapRight = () => {
    return (
        <div 
            className="envelope-flap-right absolute inset-0 z-20"
            style={{
                width: '50%',
                height: '100%',
                left: '50%',
        ...
        >
            ...
            <div 
                ...
                style={{
                    background: 'linear-gradient(to left, #F5EDE4 0%, #FFFEF7 50%, #FFF8F0 100%)',
...
export default EnvelopeFlapRight;
